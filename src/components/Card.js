...
const Card = ({ data }) => {
  return (
    <div
      ...
      <div className="h5 date mb-3">{data.date}</div>
      <div className="h5 time">{data.time}</div>
      <div className="h5 time mb-3">{data.time2}</div>
