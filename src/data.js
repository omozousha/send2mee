export const data = {
  en: {
    ...
    moment: {
      images: [
        {
          src: require('./assets/images/moment/01.webp'),
          thumbnail: require('./assets/images/moment/thumbnails/01.webp'),
          thumbnailWidth: 240,
          thumbnailHeight: 320,
        },
        {
          src: require('./assets/images/moment/02.webp'),
          thumbnail: require('./assets/images/moment/thumbnails/02.webp'),
          thumbnailWidth: 240,
          thumbnailHeight: 320,
        },
        {
          src: require('./assets/images/moment/03.webp'),
          thumbnail: require('./assets/images/moment/thumbnails/03.webp'),
          thumbnailWidth: 240,
          thumbnailHeight: 320,
        },
        {
          src: require('./assets/images/moment/04.webp'),
          thumbnail: require('./assets/images/moment/thumbnails/04.webp'),
          thumbnailWidth: 240,
          thumbnailHeight: 320,
        },
        {
          src: require('./assets/images/moment/05.webp'),
          thumbnail: require('./assets/images/moment/thumbnails/05.webp'),
          thumbnailWidth: 240,
          thumbnailHeight: 320,
        },
        {
          src: require('./assets/images/moment/06.webp'),
          thumbnail: require('./assets/images/moment/thumbnails/06.webp'),
          thumbnailWidth: 240,
          thumbnailHeight: 320,
        },
      ],
